---
slug: "who-to-complain-to-about-a-medical-bill"
title: "Who to Complain to About a Medical Bill (and Who Acts)"
description: "Where to complain about a medical bill - hospital, state regulators, CFPB, CMS - what each door actually handles, and what to expect after you file."
cluster: "claim"
order: "8"
...
| Insurer appeals & grievances         | Denials, claim-processing errors                                    | [Written internal appeal within 180 days](https://www.healthcare.gov/appeal-insurance-company-decision/internal-appeals/) |
| State insurance department           | Insurer conduct, failed appeals                                     | [Your state DOI's complaint form](https://content.naic.org/consumer/how-to-file-complaint)                                |
| State attorney general               | Hospital billing practices, collection abuse, charity care          | Your AG's consumer complaint form - [find yours](https://www.naag.org/find-my-ag/)                                        |
| CFPB                                 | Debt collectors, credit-report errors                               | [consumerfinance.gov/complaint](https://www.consumerfinance.gov/complaint/)                                               |
| CMS No Surprises Help Desk           | Surprise billing, good-faith-estimate violations                    | [Online](https://www.cms.gov/medical-bill-rights/help/submit-a-complaint) or 1-800-985-3059                               |
| HHS Office of Inspector General      | Medicare/Medicaid fraud                                             | [oig.hhs.gov](https://oig.hhs.gov/fraud/report-fraud/) or 1-800-HHS-TIPS                                                  |

## Start where the mistake lives: inside the hospital

**Billing department.** Every dispute starts here - outside agencies will ask what the hospital said. Call with your account number, name the exact lines you dispute, then follow up in writing and ask for a written response. Attach your itemized bill and EOB. Expect a correction, a payment-plan offer, or a form-letter denial; any of those advances your case. Exact wording: [hospital billing phone scripts](/learn/hospital-billing-phone-scripts). If you don't have the itemized bill yet, [get it first](/learn/how-to-get-an-itemized-hospital-bill) - it's the foundation for every other door on this list.
...
**Compliance office.** This is the door for policy violations rather than math errors: you asked for a financial-assistance application and got silence, or collections started while your application sat unprocessed. Nonprofit hospitals' billing and collection conduct is [regulated by the IRS as a condition of tax exemption](https://www.irs.gov/charities-non-profits/billing-and-collections-section-501r6) - a written complaint that names the specific conduct tends to get routed seriously. Background on what they owe you: [hospital charity care and financial assistance](/learn/hospital-charity-care-financial-assistance).

## When is the insurer the right target?

If the problem is a denial, a processing error, or a network mistake, the hospital can't fix it - your insurer can. You have [180 days from a denial to file an internal appeal](https://www.healthcare.gov/appeal-insurance-company-decision/internal-appeals/), and the insurer must decide within 30 days for care you haven't received, 60 for care you already got. Attach the denial letter, the EOB, and anything from your doctor supporting medical necessity. If you lose the internal appeal, you can take the same file to an independent external review. Take a look at [how to appeal a denied health insurance claim](/learn/how-to-appeal-a-denied-health-insurance-claim) and [how to read an EOB](/learn/how-to-read-an-eob) for more information on insurer appeals. 
...
Two notes: 
1. States are also the [primary enforcers of the federal No Surprises Act](https://www.cms.gov/files/document/nsa-state-laws-q-and-a.pdf) for the insurers and providers they regulate. CMS only steps in for cases where a state doesn't enforce. This means a surprise-billing complaint against a state-regulated plan belongs here too (see [what the Act covers](/learn/no-surprises-act-explained) for more information). 
2. If your coverage comes through a large employer that self-funds its plan, the DOI usually can't touch it - that's federal territory, which is one more reason to exhaust the insurer's own appeal process.
...
Only for suspected **fraud against Medicare, Medicaid, or other HHS programs**: billing for visits that never happened, equipment never delivered, a deceased patient's ID billed. Report [online](https://oig.hhs.gov/fraud/report-fraud/) or at **1-800-HHS-TIPS** (1-800-447-8477). Set expectations accordingly: OIG says its complaint volume is too high to contact every complainant. It is not the door for an ordinary pricing dispute - that's the billing office, the AG, or the doors above.

## What to attach, whichever door you pick

The same evidence file works everywhere: the itemized bill, the EOB, your written dispute and every written response, and a dated log of calls. If you haven't built that file yet, do it in this order: [get the itemized bill](/learn/how-to-get-an-itemized-hospital-bill), [check whether you were overcharged](/learn/how-to-know-if-you-were-overcharged), and follow [the first-30-days timeline](/learn/what-to-do-when-you-get-a-hospital-bill). Agencies act on records, not frustration.

## The fastest free way to do all of this

Every door above works better with a clean paper trail and building one is exactly what **[Candid](https://www.candidclaim.com/?utm_campaign=who-to-complain-to-about-a-medical-bill)** does, for free. It audits the bill against your EOB and plan, flags the disputable lines, drafts the letters, and tracks what you sent and who owes you a response. So when you knock on any door on this list, the documented case is already in your hand. Filing the complaints is your move; you review and send everything.
...
High prices alone usually aren't a violation, so no regulator will referee "too expensive." Your levers are different doors: [financial assistance](/learn/hospital-charity-care-financial-assistance) and [negotiation](/learn/how-to-negotiate-a-medical-bill). If the price violates something specific - your estimate, your plan contract, surprise-billing rules - then use the matching door above.

### Is there a deadline to file a complaint?

Most complaint portals don't impose strict deadlines, but the underlying rights do: 180 days for an internal insurance appeal, 120 days for a good-faith-estimate dispute. File while the paper trail is fresh - [the first-30-days timeline](/learn/what-to-do-when-you-get-a-hospital-bill) shows where each clock starts.

### A paid medical bill is still on my credit report. Who fixes that?

Under the nationwide bureaus' current policies, paid medical collections should be removed - the CFPB has [described those policies here](https://www.consumerfinance.gov/about-us/blog/medical-debt-anything-already-paid-or-under-500-should-no-longer-be-on-your-credit-report/). Dispute it with the bureau in writing with proof of payment; if it isn't corrected, file a CFPB complaint against the bureau and the furnisher.
