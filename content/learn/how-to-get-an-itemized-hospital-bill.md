---
slug: "how-to-get-an-itemized-hospital-bill"
title: "How to Get an Itemized Bill From a Hospital"
description: "The exact scripts for requesting an itemized hospital bill, what the billing codes are, what to check first, and what to do if the hospital stalls."
cluster: "claim"
order: "4"
...
| Information       | Summary statement                                | Itemized bill           |
| ----------------- | ------------------------------------------------ | ----------------------- |
| Line items        | A few category totals ("Pharmacy," "Laboratory") | Every individual charge |
| Billing codes     | None                                             | One per line            |
| Dates             | Statement date                                   | Date of each service    |
| Quantities        | Not shown                                        | Units for each line     |
...
The itemized bill alone shows what they charged. Only next to your EOB (explanation of benefits - your insurer's statement of what you actually owe) does it show what's *wrong*. Match the two line by line using our guide for a [15-minute overcharge check](/learn/how-to-know-if-you-were-overcharged); if you've never dissected an EOB, you can start with [how to read an EOB](/learn/how-to-read-an-eob).
...
You don't even have to write the request yourself. **[Candid](https://www.candidclaim.com/?utm_campaign=how-to-get-an-itemized-hospital-bill)** drafts the itemized-bill request letter for you. And once the bill arrives, it does the hard part of decoding the line items, matching them against your EOB / plan, flagging what's wrong, and drafting the dispute. All for free.
