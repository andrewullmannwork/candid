---
slug: "hospital-billing-phone-scripts"
title: "What to Say to Hospital Billing: 6 Exact Scripts"
description: "Six word-for-word scripts for calling the hospital billing office - itemized bill, error dispute, charity care, discounts, settlement, escalation."
cluster: "claim"
order: "6"
...
4. A self-pay discount rate
5. A settlement
6. An escalation. Then get everything in writing.

The billing office fields these calls all day. You'll make maybe a handful in your life. That means they know the process and you don't. That's intimidating. Scripts close the gap. In a [2022 KFF survey](https://www.kff.org/health-costs/report/kff-health-care-debt-survey/), 41% of U.S. adults reported carrying debt from medical or dental bills. A lot of that debt started as a bill nobody questioned. ***You're going to question yours.***

## Three rules before you dial

1. **Every call has one goal.** Not "figure out this bill." One concrete thing the rep can do before you hang up: send the itemized bill, open a review, mail the financial-assistance application. If you have three goals, you have three calls.
2. **Every call produces a paper trail.** Open the call by getting the rep's first name. Close it by asking for a reference or ticket number for the call. If they can't give a number, ask them to read back the note they put on your account. No exceptions - this is the whole game.
3. **Calls start things. Letters finish them.** A phone call opens a review, requests a document, gets a hold placed. Anything that resolves money - a correction, a discount, a settlement - isn't real until it's in writing. The written playbook lives in [how to fight a medical bill](/learn/how-to-fight-a-medical-bill).

Why the paranoia about names and reference numbers? Because promised callbacks routinely evaporate. In a KFF Health News ["Bill of the Month" case](https://kffhealthnews.org/news/article/hearing-implant-preapproved-met-deductible-bill-of-the-month/), Caitlyn Mai's cochlear implant surgery was pre-approved by her insurer - and she was billed $139,362.74 anyway. "I've never got that call back from a supervisor to this day," she told KFF Health News after twelve-plus hours of phone calls. Her claim was finally paid, more than 90 days after surgery, and she owed nothing. She won by keeping records and calling anyway.
...
This is almost always your first call. A summary bill ("Hospital services - $8,412") can't be audited; an itemized bill lists every charge line by line. The [CFPB's guidance for medical bills](https://www.consumerfinance.gov/ask-cfpb/what-should-i-do-if-i-cant-pay-a-medical-bill-en-2125/) starts in the same place: ask for an itemized list of charges and check that they reflect the care you actually received.
...
What to do with the itemized bill once it arrives is covered in [how to get an itemized hospital bill](/learn/how-to-get-an-itemized-hospital-bill) and [how to know if you were overcharged](/learn/how-to-know-if-you-were-overcharged).

### Script 2: The Error-dispute Call

For when your audit found something - a duplicate line, a service you didn't receive, a quantity that's wrong. Common patterns are cataloged in [common medical billing errors](/learn/common-medical-billing-errors).
...
Nonprofit hospitals are required, as a condition of their federal tax exemption, to maintain a written financial assistance policy - and to [publicize it widely](https://www.irs.gov/charities-non-profits/financial-assistance-policy-and-emergency-medical-care-policy-section-501r4), per IRS rules under Section 501(r). Many for-profit hospitals have policies too. A phone rep "guessing you won't qualify" is NOT a determination - the application is.
...
Income thresholds, the application walkthrough, and what to do if you're denied: [hospital charity care and financial assistance](/learn/hospital-charity-care-financial-assistance).
...
The number-picking strategy - where to start, when to climb - is in [how to negotiate a medical bill](/learn/how-to-negotiate-a-medical-bill). The phrase that matters most is **"as payment in full."** Get it in the written agreement or it's just a partial payment.
...
**On recording calls:** laws vary by state. Some states allow recording when one party to the call consents (you count); others require every party's consent, and it can matter which states the two ends of the call are in - the [Reporters Committee for Freedom of the Press keeps a plain-English state-by-state guide](https://www.rcfp.org/introduction-to-reporters-recording-guide/). The safe default everywhere: ask on the call ("Do you mind if I record this so I have an accurate record?") - or skip recording and take dated written notes instead. Nobody's consent is needed for a notebook, and a good log is nearly as powerful.

## When to stop calling

Switch from phone to certified mail the moment any of these is true:

1. **Money is being resolved.** Corrections, discounts, settlements - final terms belong on paper. Don't pay a cent before everything is in writing. 
2. **You're repeating yourself.** Two calls about the same unresolved issue is the limit. The third contact is a dispute letter - dated, specific, sent certified with return receipt. Template and sequence: [how to fight a medical bill](/learn/how-to-fight-a-medical-bill).
3. **A collector is involved.** Once the account leaves the hospital, you're dealing with a different counterparty under different rules - read [medical bills in collections](/learn/medical-bill-in-collections) before your next conversation.
...
It depends on your state's consent law - some require only one party's consent, others require everyone's, and cross-state calls complicate it further. The [Reporters Committee guide](https://www.rcfp.org/introduction-to-reporters-recording-guide/) summarizes each state. The universally safe move: ask permission on the call, or take dated written notes instead - no consent law touches a notebook.
...
No - the order runs the other way. Screening for financial assistance (which [nonprofit hospitals must offer a written policy for](https://www.irs.gov/charities-non-profits/financial-assistance-policy-and-emergency-medical-care-policy-section-501r4)) can shrink or erase the bill before you ever need to haggle over what's left.
