---
slug: "how-to-negotiate-a-medical-bill"
title: "How to Negotiate a Medical Bill (With Scripts)"
description: "Yes, you can negotiate a medical bill. The exact order to ask in - error fix, financial aid, discounts, settlement, payment plan - with phone scripts."
cluster: "claim"
order: "2"
...
So first: get the [itemized bill](/learn/how-to-get-an-itemized-hospital-bill) and match it against your EOB (explanation of benefits - your insurer's statement of what you actually owe), line by line. The 15-minute method is in [how to know if you were overcharged](/learn/how-to-know-if-you-were-overcharged). Whatever survives that audit is the real number. That's what you negotiate.
...
| Rung | The ask                            | When it fits                                                     |
| ---- | ---------------------------------- | ---------------------------------------------------------------- |
| 1    | Fix the errors                     | Anything that failed your audit                                  |
| 2    | Screen me for financial assistance | Income-based help; nonprofit hospitals must have a policy by law |
| 3    | Self-pay / prompt-pay discount     | You're paying directly, or paying fast                           |
| 4    | Lump-sum settlement                | You can pay a real amount today to close the account             |
| 5    | Interest-free payment plan         | Whatever remains after rungs 1-4                                 |
...
If the error is real and they won't fix it, you've left negotiation territory - that's a dispute, and the written-dispute playbook is [how to fight a medical bill](/learn/how-to-fight-a-medical-bill).
...
| Date | Who I spoke to | What was said | Reference # |
| --- | --- | --- | --- |
