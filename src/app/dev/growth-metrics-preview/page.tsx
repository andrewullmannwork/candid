...
const MOCK: GrowthMetrics = {
  ...
  window: "30d",
  totals: { signups: 36, uploaders: 14, uploads: 23, attributedSignups: 27, attributedPct: 75 },
  bySource: [
    { source: "reddit", signups: 14, uploaders: 6, uploads: 9 },
    { source: "(direct / untagged)", signups: 9, uploaders: 3, uploads: 4 },
    { source: "google", signups: 6, uploaders: 2, uploads: 3 },
    { source: "creator-popcorn", signups: 4, uploaders: 2, uploads: 5 },
    { source: "chatgpt.com", signups: 3, uploaders: 1, uploads: 2 },
  ],
  byCampaign: [
