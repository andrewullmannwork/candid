...
export async function getFlags() {
  return {
    ...
    OCR_DAILY_PAGE_LIMIT: await getFlagInt("OCR_DAILY_PAGE_LIMIT", 50),
    ...
    UPLOAD_MAX_PAGES: await getFlagInt("UPLOAD_MAX_PAGES", 20),
...
export const FLAGS = {
  ...
  OCR_DAILY_PAGE_LIMIT: envInt("OCR_DAILY_PAGE_LIMIT", 50),
  ...
  UPLOAD_MAX_PAGES: envInt("UPLOAD_MAX_PAGES", 20),
